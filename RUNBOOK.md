...
```bash
python3 "$ARCHON_LAYER/setup/archon-run.py" feature-scope-amend <run-id> --chain <chain-id> --add-file <repo-relative-tracked-file> --reason "Authorized scope recovery"
bash "$ARCHON_LAYER/setup/resume.sh" <run-id>
```
