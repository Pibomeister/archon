...
rules for this diff, and run its validator pass. Do not cap the set, and do not
add a custom lens beyond what the skill dispatches: a measured cap (three
personas) saved no wall time and lost a P1 the full set had found.
